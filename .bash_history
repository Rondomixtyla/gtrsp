...
git add .
git commit -m "Sploop.io Age atlama item secim menusu ve yeni silahlar/yapilar eklendi"
git push
...
git add .
git commit -m "Sploop.io tam paket: Sapka magazasi UI, klan destegi temelleri ve biyom cizimleri eklendi"
git push
